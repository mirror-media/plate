...
Watch.add({
  brand: { label: '品牌', type: Types.Relationship, ref: 'Audio' },
  name: { label: '品名', type: String },
  type: { label: '型號', type: String },
  watchImage: { label: '圖片', type: Types.ImageRelationship, ref: 'Image' },
  price: { label: '價格', type: Types.Select, options: 'NTD30000以下, NTD30000~NTD70000, NTD70000~NTD150000, NTD150000~NTD300000, NTD300000~NTD500000, NTD500000~NTD1500000, NTD500000~NTD1500000,NTD3000000以上', index: true },
...
Watch.defaultColumns = 'name, state|20%, WatchDate|20%, isFeatured|20%';
