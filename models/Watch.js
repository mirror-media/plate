...
Watch.add({
  ...
  luminous: { label: '夜光', type: Boolean, index: true},
  movement: { label: '機芯', type: Types.Select, options: '自動上鏈, 手動上鏈, 石英, 光動能, 人動電能, GPS, 電波, 智能錶' },
  power: { label: '動力', type: String },
  size: { label: '錶殼尺寸', type: String },
  color: { label: '面盤顏色', type: String },
  youtube: { label: 'Youtube 影片', type: Types.Url },
  ...
  relatedwatch: { label: '相似錶款', type: Types.Relationship, ref: 'Watch', many: true },
